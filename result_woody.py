...
class ResultWindow(QMainWindow):
    def __init__(self):
        ...
        with open('file/contents/contents_woody.txt', 'r', encoding='utf8') as file:
            content = file.read()
            self.content = QLabel(content, self)
            self.content.resize(640, 150)
            self.content.move(380, 80)
        ...
        self.product1.setPixmap(QPixmap('image/products/woody/img1.png'))
        ...
        self.product2.setPixmap(QPixmap('image/products/woody/img2.png'))
    ...
    def moreProduct(self):
        from product_woody import ProductWindow
