...
class ResultWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        # window setting
        self.setStyleSheet('background-color: #9FF77F')
        ...
        self.typeName.setPixmap(QPixmap('image/type/type_green.png'))
        ...
        self.typeHT.setPixmap(QPixmap('image/type/hashtag/HT_green.png'))
        self.typeHT.resize(240, 30)
        self.typeHT.move(102, 355)
        self.typeHT.setAlignment(Qt.AlignCenter)
        self.typeHT.setScaledContents(1)  # 이미지 크기에 맞게 조정

        self.typeHT = QLabel('', self)
        self.typeHT.setPixmap(QPixmap('image/type/contents/contents_green.png'))
        self.typeHT.resize(650, 150)
        self.typeHT.move(380, 80)
        self.typeHT.setAlignment(Qt.AlignCenter)
        self.typeHT.setScaledContents(1)  # 이미지 크기에 맞게 조정
