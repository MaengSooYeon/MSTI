...
class ResultWindow(QMainWindow):
    def __init__(self):
        ...
        with open('file/contents/contents_fruity.txt', 'r', encoding='utf8') as file:
            content = file.read()
            self.content = QLabel(content, self)
            self.content.resize(680, 130)
            self.content.move(360, 90)
        ...
        self.product1.setPixmap(QPixmap('image/products/fruity/img1.png'))
        ...
        self.product2.setPixmap(QPixmap('image/products/fruity/img2.png'))
    ...
    def moreProduct(self):
        from product_fruity import ProductWindow
