...
class ProductWindow(QMainWindow):
    def __init__(self):
        ...
        self.product2.setPixmap(QPixmap('image/products/green/img4.png'))
        ...
        self.product3.setPixmap(QPixmap('image/products/green/img5.png'))
        ...
        self.product4.setPixmap(QPixmap('image/products/green/img6.png'))
