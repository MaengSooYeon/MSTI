...
class ProductWindow(QMainWindow):
    def __init__(self):
        ...
        self.product1.setPixmap(QPixmap('image/products/musk/img3.png'))
        ...
        self.product2.setPixmap(QPixmap('image/products/musk/img4.png'))
        self.product2.resize(480, 225)
        self.product2.move(16, 320)
        self.product2.setAlignment(Qt.AlignCenter)
        self.product2.setScaledContents(1)  # 이미지 크기에 맞게 조정

        self.product3 = QLabel('', self)
        self.product3.setPixmap(QPixmap('image/products/musk/img5.png'))
        ...
        self.product4.setPixmap(QPixmap('image/products/musk/img6.png'))
