...
class ProductWindow(QMainWindow):
    def __init__(self):
        ...
        self.product1.setPixmap(QPixmap('image/products/fruity/img3.png'))
        self.product1.resize(480, 225)
        self.product1.move(26, 100)
        self.product1.setAlignment(Qt.AlignCenter)
        self.product1.setScaledContents(1)  # 이미지 크기에 맞게 조정

        self.product2 = QLabel('', self)
        self.product2.setPixmap(QPixmap('image/products/fruity/img4.png'))
        ...
        self.product3.setPixmap(QPixmap('image/products/fruity/img5.png'))
        self.product3.resize(480, 225)
        self.product3.move(510, 100)
        self.product3.setAlignment(Qt.AlignCenter)
        self.product3.setScaledContents(1)  # 이미지 크기에 맞게 조정

        self.product4 = QLabel('', self)
        self.product4.setPixmap(QPixmap('image/products/fruity/img6.png'))
        self.product4.resize(480, 225)
        self.product4.move(510, 320)
