...
class ResultWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        # window setting
        self.setStyleSheet('background-color: #5D683E')
        ...
        with open('file/contents/contents_tobacco-leather.txt', 'r', encoding='utf8') as file:
            content = file.read()
            self.content = QLabel(content, self)
            self.content.resize(710, 150)
            self.content.move(340, 80)
        ...
        self.product1.setPixmap(QPixmap('image/products/tobacco_leather/img1.png'))
        ...
        self.product2.setPixmap(QPixmap('image/products/tobacco_leather/img2.png'))
    ...
    def moreProduct(self):
        from product_tobacco_leather import ProductWindow
