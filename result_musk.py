...
class ResultWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        # window setting
        self.setStyleSheet('background-color: #E2DBC3')
        ...
        self.typeImg.setPixmap(QPixmap('image/type/icon/musk.png'))
        ...
        self.typeName.setPixmap(QPixmap('image/type/type_musk.png'))
        ...
        self.typeHT.setPixmap(QPixmap('image/type/hashtag/HT_musk.png'))
        ...
        with open('file/contents/contents_musk.txt', 'r', encoding='utf8') as file:
            content = file.read()
            self.content = QLabel(content, self)
            self.content.resize(660, 150)
            self.content.move(370, 90)
        ...
        self.product1.setPixmap(QPixmap('image/products/musk/img1.png'))
        ...
        self.product2.setPixmap(QPixmap('image/products/musk/img2.png'))
    ...
    def moreProduct(self):
        from product_musk import ProductWindow
