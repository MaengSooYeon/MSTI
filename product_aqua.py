...
class ProductWindow(QMainWindow):
    def __init__(self):
        ...
        self.product1.setPixmap(QPixmap('image/products/aqua/img3.png'))
        ...
        self.product2.setPixmap(QPixmap('image/products/aqua/img4.png'))
        ...
        self.product3.setPixmap(QPixmap('image/products/aqua/img5.png'))
        self.product3.resize(480, 225)
        self.product3.move(505, 100)
        self.product3.setAlignment(Qt.AlignCenter)
        self.product3.setScaledContents(1)  # 이미지 크기에 맞게 조정

        self.product4 = QLabel('', self)
        self.product4.setPixmap(QPixmap('image/products/aqua/img6.png'))
